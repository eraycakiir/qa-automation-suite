...
# 💡 Gerekli tüm Playwright UI bağımlılıklarını yükle
RUN apt-get update && apt-get install -y \
    wget unzip zip gnupg \
    ...
    libx11-6 libxext6 libxfixes3 libpango-1.0-0 libcairo2 && \
...
# 🧪 Stage 2 - Generate & Package Allure Report
